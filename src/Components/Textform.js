...
export default function Textform(props) {
    ...
    <div className='container' className={`text-${props.mode === 'light' ? 'dark' : 'light'}`} >
       <h1> {props.heading} </h1>

       <div className="mb-3">
       <textarea className="form-control" id="myBox" rows="13"   onChange={handleOnChange} value = {Text} 
    ...
    <div className='container my-3'  className={`text-${props.mode === 'light' ? 'dark' : 'light'}`} >
